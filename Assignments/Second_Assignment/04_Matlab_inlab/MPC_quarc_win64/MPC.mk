...
MODEL                = MPC
MODULES              = MPC_data.c MPC_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = MPC.mk
...
S_FUNCTIONS_LIB      = C:\Users\Public\Documents\qpOases\x64\Release\qpOasesLib.lib C:\PROGRA~1\Quanser\QUARC\lib\win64\hil.lib C:\PROGRA~1\Quanser\QUARC\lib\win64\QUDCFC~1.LIB C:\PROGRA~1\Quanser\QUARC\lib\win64\QUANSE~4.LIB
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 0
COMPUTER             = PCWIN64
BUILDARGS            =  MAT_FILE=0 SHOW_TIMES=0 DEBUG=0 DEBUG_HEAP=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         = 0
EXT_MODE             = 1
...
MODELLIB                  = MPClib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = MPC_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\local\Desktop\_OAC_Lab\Second_Assignment\04_Matlab_inlab\03_Matlab_preperation
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\MPC_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Public\Documents\qpOases\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Public\Documents\qpOases\x64\Release
...
# Set QUARC libraries
QUARC_LIBS = quanser_runtime.lib quanser_common.lib ippcvmt.lib ippimt.lib ippsmt.lib ippvmmt.lib ippcoremt.lib shell32.lib
