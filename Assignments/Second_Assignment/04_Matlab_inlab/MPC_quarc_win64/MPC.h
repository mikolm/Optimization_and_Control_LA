...
#define MPC_rtModel                    RT_MODEL_MPC_T
...
typedef struct {
  ...
  int32_T iter;                        /* '<Root>/qpOASES-native' */
  int32_T error;                       /* '<Root>/qpOASES-native' */
} B_MPC_T;
...
typedef struct {
  ...
  real_T HILReadAnalog1_Buffer[4];     /* '<S1>/HIL Read Analog1' */
  real_T DiscreteTransferFcn1_tmp;     /* '<Root>/Discrete Transfer Fcn1' */
  real_T HILWriteAnalog2_Buffer[2];    /* '<S1>/HIL Write Analog2' */
  t_card HILInitialize_Card;           /* '<Root>/HIL Initialize' */
  void *HILReadAnalog1_PWORK;          /* '<S1>/HIL Read Analog1' */
  struct {
    void *LoggedData;
  ...
  void *HILWriteAnalog2_PWORK;         /* '<S1>/HIL Write Analog2' */
  ...
  boolean_T initialized_not_empty;     /* '<Root>/qpOASES-native' */
  qpOASES_Options options;             /* '<Root>/qpOASES-native' */
} DW_MPC_T;

/* Backward compatible GRT Identifiers */
#define rtB                            MPC_B
#define BlockIO                        B_MPC_T
#define rtP                            MPC_P
#define Parameters                     P_MPC_T
#define rtDWork                        MPC_DW
#define D_Work                         DW_MPC_T

/* Parameters (default storage) */
struct P_MPC_T_ {
  real_T F[80];                        /* Variable: F
                                        * Referenced by: '<Root>/Gain6'
                                        */
  real_T Fx[160];                      /* Variable: Fx
                                        * Referenced by: '<Root>/Gain12'
                                        */
  real_T G[40];                        /* Variable: G
                                        * Referenced by: '<Root>/Gain5'
                                        */
  real_T Gx[80];                       /* Variable: Gx
                                        * Referenced by: '<Root>/Gain11'
                                        */
  real_T H[800];                       /* Variable: H
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T Hx[1600];                     /* Variable: Hx
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T L[20];                        /* Variable: L
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T M[400];                       /* Variable: M
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T Nc;                           /* Variable: Nc
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T Np;                           /* Variable: Np
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T Q[1600];                      /* Variable: Q
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T R[400];                       /* Variable: R
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T gainh1;                       /* Variable: gainh1
                                        * Referenced by: '<S1>/Gain'
                                        */
  real_T gainh2;                       /* Variable: gainh2
                                        * Referenced by: '<S1>/Gain1'
                                        */
  real_T h[2];                         /* Variable: h
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T m;                            /* Variable: m
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
  ...
  real_T n;                            /* Variable: n
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T offseth1;                     /* Variable: offseth1
                                        * Referenced by: '<S1>/Constant1'
                                        */
  real_T offseth2;                     /* Variable: offseth2
                                        * Referenced by: '<S1>/Constant2'
                                        */
  real_T p;                            /* Variable: p
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T roh;                          /* Variable: roh
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T u_eq[2];                      /* Variable: u_eq
                                        * Referenced by:
                                        *   '<Root>/build_matrices_inlab_opt'
                                        *   '<Root>/Constant2'
                                        */
  real_T u_lower_limit;                /* Variable: u_lower_limit
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T u_upper_limit;                /* Variable: u_upper_limit
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T x_eq[2];                      /* Variable: x_eq
                                        * Referenced by:
                                        *   '<Root>/build_matrices_inlab_opt'
                                        *   '<Root>/Constant1'
                                        *   '<Root>/Constant3'
                                        */
  real_T x_lower_limit[2];             /* Variable: x_lower_limit
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  real_T x_upper_limit[2];             /* Variable: x_upper_limit
                                        * Referenced by: '<Root>/build_matrices_inlab_opt'
                                        */
  ...
  real_T CompareToConstant1_const;     /* Mask Parameter: CompareToConstant1_const
                                        ...
                                        */
  uint32_T HILReadAnalog1_channels[4]; /* Mask Parameter: HILReadAnalog1_channels
                                        * Referenced by: '<S1>/HIL Read Analog1'
                                        */
  uint32_T HILWriteAnalog2_channels[2];/* Mask Parameter: HILWriteAnalog2_channels
                                        * Referenced by: '<S1>/HIL Write Analog2'
                                        */
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Constant4_Value[40];          /* Expression: repmat([15 + h(2)],Np,1)
                                        * Referenced by: '<Root>/Constant4'
                                        */
  real_T UnitDelay1_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<Root>/Unit Delay1'
                                        */
  real_T Constant7_Value[2];           /* Expression: [h01; h02]
                                        * Referenced by: '<Root>/Constant7'
                                        */
  real_T DiscreteTransferFcn1_NumCoef[2];/* Expression: [1 0]
                                          * Referenced by: '<Root>/Discrete Transfer Fcn1'
                                          */
  real_T DiscreteTransferFcn1_DenCoef[2];/* Expression: [1 -1]
                                          * Referenced by: '<Root>/Discrete Transfer Fcn1'
                                          */
  ...
  boolean_T HILReadAnalog1_Active;     /* Computed Parameter: HILReadAnalog1_Active
                                        * Referenced by: '<S1>/HIL Read Analog1'
                                        */
  boolean_T HILWriteAnalog2_Active;    /* Computed Parameter: HILWriteAnalog2_Active
                                        * Referenced by: '<S1>/HIL Write Analog2'
                                        */
...
extern void MPC_output(void);
extern void MPC_update(void);
extern void MPC_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern MPC_rtModel *MPC(void);
 ...
 *
 * '<Root>' : 'MPC'
 * '<S1>'   : 'MPC/3Tank Modell 1'
 * '<S2>'   : 'MPC/build_matrices_inlab_opt'
 * '<S3>'   : 'MPC/qpOASES-native'
 * '<S4>'   : 'MPC/3Tank Modell 1/Compare To Constant1'
 * '<S5>'   : 'MPC/3Tank Modell 1/Compare To Constant2'
 * '<S6>'   : 'MPC/3Tank Modell 1/Compare To Constant3'
 */
