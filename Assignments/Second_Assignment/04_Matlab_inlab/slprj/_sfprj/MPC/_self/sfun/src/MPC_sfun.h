#ifndef __MPC_sfun_h__
#define __MPC_sfun_h__
...
extern uint32_T _MPCMachineNumber_;
...
extern mxArray* load_MPC_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_MPC_optimization_info(void);
